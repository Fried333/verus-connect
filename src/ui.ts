...
/**
 * Safely insert SVG content into a container using DOMParser.
 * Parses the SVG string as XML, validates it contains only an <svg> element,
 * and strips all event handler attributes and script elements before inserting.
 * Falls back gracefully if parsing fails.
 */
function safeSvgInsert(container: HTMLElement, svgHtml: string): void {
  try {
    ...
    // Parsing failed — don't insert anything
  }
}
