...
import { openDeepLink, isValidDeepLink } from './deeplink';
...
export class VerusConnect {
  ...
  async login(options?: LoginOptions): Promise<LoginResult> {
    ...
    try {
      ...
      // Validate the deep link URI before showing it to the user.
      // This prevents MITM attacks where an attacker replaces the server
      // response with a malicious URL (phishing site, javascript:, etc.)
